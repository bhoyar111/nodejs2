...
import validateRegister from '../../../requests/mobile/RegisterRequest';
import validateVerifyRegister from '../../../requests/mobile/verifyRegisterRequest';
import validateLogin from '../../../requests/mobile/loginRequest';
import validateVerifyLogin from '../../../requests/mobile/verifyLoginRequest';
...
export default {
    ...
    async getVerifyRegister(req, res){
        try {
            const { error } = validateVerifyRegister(req.body);
            if (error) return res.status(bad_request).send({ error: getValidationErrMsg(error) });
